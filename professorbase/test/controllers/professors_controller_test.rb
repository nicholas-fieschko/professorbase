...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { address: @professor.address, bio: @professor.bio, email: @professor.email, phone: @professor.phone, profile_link: @professor.profile_link, title: @professor.title, website: @professor.website }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { address: @professor.address, bio: @professor.bio, email: @professor.email, phone: @professor.phone, profile_link: @professor.profile_link, title: @professor.title, website: @professor.website }
    assert_redirected_to professor_path(assigns(:professor))
  end
